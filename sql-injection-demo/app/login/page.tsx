  ...
  return (
    <div className="login-container">
        ...
        {user ? (
          <div className="alert alert-success">
            ...
            <div style={{ marginTop: '1rem' }}>
              <a href={`/messages/${user.id}`} className="btn">Ver Mensagens</a>
            </div>
          </div>
        ) : (
          <>
      ...
      <div className="card code-example">
        ...
        <p>Tente este ataque:</p>
        <div className="code-block">
          <p>Usuário: admin&apos; --</p>
          <p>Senha: qualquer_coisa</p>
        </div>
        <p>Isto comentará o resto da consulta SQL, fazendo com que a verificação de senha seja ignorada.</p>
      </div>
    </div>
  );
} 